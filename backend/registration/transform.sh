...
if [ "$#" -ne 6 ]; then
    echo "Usage: $0 <niftyreg_executable> <fixed_image> <moving_image> <transformed_image> <transformation_matrix> interpolation_method(0=NN, 1=LIN; 3=CUB, 4=SINC)"
    exit 1
fi
...
interpolation_method="$6"  # Choose the appropriate interpolation method (e.g., 0, 1, 3)
